  ...
  function microupload_send(file, options) {
    ...
    if (options.container) {
      ...
      if (obj_container) {
        ...
        var obj_filenames = document.createElement('div');
        obj_filenames.className = "microupload_filename";
        obj_item.appendChild(obj_filenames);

        var obj_filename = document.createElement('p');
        obj_filename.className = "microupload_fileName";
        obj_filename.innerText = file.name;
        obj_filenames.appendChild(obj_filename);
        ...
        if (options.cancelable) {
          ...
          obj_filenames.appendChild(obj_cancel);
        }
      }
    }
