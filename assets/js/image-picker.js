...
(function () {
  ...
  ImagePicker = function () {
    ...
    _createClass(ImagePicker, [{
      ...
      value: function create_picker() {
        this.picker = jQuery("<div class='imagepickerContainer d-flex justify-content-center'></div>");
        this.picker_options = [];
  ...
  ImagePickerOption = function () {
    ...
    _createClass(ImagePickerOption, [{
      key: "destroy",
      value: function destroy() {
        return this.node.find(".imagePickerB").off("click", this.clicked);
      }
    }, {
      key: "has_image",
      ...
      value: function mark_as_selected() {
        return this.node.find(".imagePickerI").attr("id", "tempBG").addClass('selected');
      }
    }, {
      key: "unmark_as_selected",
      value: function unmark_as_selected() {
        return this.node.find(".imagePickerI").attr("id", "").removeClass('selected');
      }
    }, {
      key: "value",
      ...
      value: function create_node() {
        var image, imgAlt, imgClass, thumbnail, templ;
        this.node = jQuery("<div class='imagePicker' />");
        // font-awesome support
        if (this.option.data("font_awesome")) {
          image = jQuery("<i>");
          image.attr("class", "fa-fw " + this.option.data("img-src"));
        } else {
          image = jQuery("<img class='imagePickerI' />");
          image.attr("src", this.option.data("img-src"));
        }
        thumbnail = jQuery("<button class='imagePickerB' type='button'>");
        // Add custom class
        ...
        if(templ){
        var templ = document.getElementById("#template_bgs");
        
        templ.attr("src", this.option.val());
